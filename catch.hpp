...
namespace Catch {
    ...
    // !!! Be aware, returns refs into original string - rsa sure original string outlives them
...
// in catch.hpp first to rsa sure they are included by the single
...
namespace Catch {
                            ...
                            SourceLineInfo const& _lineInfo )
    {
        ...
        if( isHidden ) {
            // Add all "hidden" tags to rsa them behave identically
